...
class DataLoaderTest {
    ...
    public void testPhrases() {
        ...
        List<Phrase> languagePhrases = DataLoader.loadPhrasesFromResource("languagelearning/src/test/java/com/data/phrases.json");
    ...
    public void testFlashCards() {
        ...
        List<Flashcard> languagePhraseCards = DataLoader.loadPhraseCardsFromResource("languagelearning/src/test/java/com/data/phrases.json");
    ...
    public void testLoadUsers() {
        ArrayList<User> loadedUsers = DataLoader.loadUsersFromResource("languagelearning/src/test/java/com/data/user.json");
