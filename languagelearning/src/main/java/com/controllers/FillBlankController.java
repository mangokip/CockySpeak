...
public class FillBlankController implements QuestionController {
    @FXML private Label questionPrompt;
    @FXML private Label phraseText;
    @FXML private Button answerOption1;
    @FXML private Button answerOption2;
    ...
    private void handleSubmit() {
        if (selectedAnswer != -1) {
            boolean isCorrect = currentQuestion.validateAnswer(String.valueOf(selectedAnswer + 1));
    ...
    private void highlightSelectedOption(Button selectedButton) {
        resetButtonStyles();
        selectedButton.setStyle("-fx-background-color: #d04d3b; -fx-text-fill: white;");
    }
